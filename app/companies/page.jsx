...
export default function CompaniesPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-100 to-blue-50 px-6 py-10">
      <h1 className="text-4xl font-bold text-center text-slate-800 mb-3 mt-4">
      ...
      <div className="max-w-5xl mx-auto mb-8 flex flex-col md:flex-row gap-4 justify-center items-center ">
        ...
        <input
          ...
          className="w-full px-5 py-3 rounded-xl bg-blue/80 border border-gray-600 shadow-lg placeholder-gray-400 backdrop-blur-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-300"
        />
        ...
        <select
          ...
          className="w-full md:w-1/3 px-5 py-3 rounded-xl bg-blue/80  border border-gray-600 shadow-lg placeholder-gray-400 backdrop-blur-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-300"
        >
      ...
      {loading ? (
        ...
        <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 max-w-7xl mx-auto">
          {filteredCompanies.map((company) => (
            <div
              key={company._id}
              className="bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 border border-gray-100 flex flex-col justify-between"
            >
              {/* Logo */}
