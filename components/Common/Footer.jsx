...
export default function Footer() {
  ...
  if (user) {
    quickLinks.splice(2, 0, { name: "Dashboard", href: "/dashboard" })
      quickLinks.splice(2, 0, { name: "Internships", href: "/internships" })
        quickLinks.splice(2, 0, { name: "Resume", href: "/resume" })
        quickLinks.splice(2, 0, { name: "Skill Match", href: "/skill-match" })
        quickLinks.splice(2, 0, { name: "Placement Rounds", href: "/placement-rounds" }
    );
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="col-span-1">
              <span className="text-xl font-bold text-gray-900">Internship & Skill Matcher</span>
            <p className="text-gray-600 leading-relaxed max-w-xs">
              Helping students find the right career path with AI-powered internship recommendations.
            </p>
          </div>
          ...
          <div className="col-span-1">
            ...
            <div className="space-y-2.5 text-gray-600">
              ...
              <p className="flex items-start">
                ...
                <a 
                  href="mailto:support@internshipandskillmatcher.com" 
