...
const CourseCard = ({ course }) => {
  return (
    ...
    transition duration-300">
      ...
      {/* ✅ Thumbnail FIX */}
      <div className="w-full h-40 flex items-center justify-center mt-10">
        {course.thumbnail ? (
          <img
      ...
      <div className="p-3 text-white">
        ...
        <a
          ...
          className="mt-3 text-center bg-blue-400 hover:bg-blue-500 
          text-white py-1.5 rounded-md text-sm transition !no-underline"
        >
          Watch Now
        </a>
      </div>
